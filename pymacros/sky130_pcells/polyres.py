...
class PolyRes(pya.PCellDeclarationHelper):
    """
    ...
    def __init__(self):
        ...
        super(PolyRes, self).__init__()

        # declare the parameters
        self.R = self.param("Rtotal", self.TypeDouble, "Total Resistance", default="1000", readonly=True)
    ...
    def draw_one_finger(self, width, length, lfx, lfy, precision):
